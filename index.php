...
/*
  Plugin Name: My Word Counting Plugin
...
class WordCountAndTimePlugin
{
    ...
    function ifWrap($content)
    {
        if (
            ...
            (get_option('wcp_wordcount', '1')
                or get_option('wcp_character_count', '1')
    ...
    function settings()
    {
        ...
        add_settings_field('wcp_readtime', 'Character Count', array($this, 'checkboxHTML'), 'word-count-settings-page', 'wcp_first_section', array('theName' => 'wcp_readtime'));
